...
// import { categories, Category } from "@/app/_data/CategoriesSidebar";
...
//           {categories.map(
//             ({ name, icon: Icon, highlight, subcategories, banner }: Category) => (
//               <li
//                 key={name}
...
//                                transition-all duration-300 ease-out w-[600px] p-6"
//                   >
//                     {/* Subcategories grid */}
