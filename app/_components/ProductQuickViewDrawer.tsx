...
// import { useRouter } from "next/navigation"; // Changed from Link for mobile reliability
...
//   // Dedicated navigation handler to ensure phone follows the link
...
//     // Navigate using the router (more reliable than Link inside AnimatePresence on mobile)
...
//             <button 
//               onClick={onClose}
//               className="absolute top-6 right-6 p-2 bg-gray-100 rounded-full text-gray-500 z-[102]"
//             >
//               <X size={20} />
//             </button>
...
//                     className="w-full bg-accent-navy text-gray-50 py-4 rounded-2xl font-black uppercase tracking-widest text-xl flex items-center justify-center gap-2 border border-gray-100 active:scale-[0.98] transition-transform touch-manipulation"
//                   >
//                     View Full Details
//                     <ArrowRight size={16} />
//                   </button>
