...
//                  <span className="text-lg md:text-xl font-black break-words">
...
//                   type="email" 
//                   name="email"
//                   placeholder="Enter you best email address" 
//                   className="w-full md:w-[500px]  bg-white rounded-2xl py-10 px-0 xxs:py-3 text-accent-navy text-sm outline-none shadow-xl font-bold placeholder:text-gray-400 focus:ring-4 focus:ring-[#002B5B]/20 transition-all"
//                   required
//                 />
//                 <button 
//                   disabled={status === "loading"} 
...
//           <div className="lg:pl-8 text-center sm:text-left">
//             <h4 className={`font-black uppercase text-brand-primary tracking-[0.4em] mb-10 text-brand-primary`}>
//               Explore 
//             </h4>
//             <ul className="space-y-6 text-[var(--footer-body-font-size)] font-bold text-blue-100/90">
//               <li><Link href="/shop" className="hover:text-[#F7931E] transition-all">All Products</Link></li>
//               <li><Link href="/vendors" className="hover:text-[#F7931E] transition-all">Top Vendors</Link></li>
//               <li><Link href="/auth/register/vendor-registration" className="hover:text-[#F7931E] transition-all">Sell on MarvelMarts</Link></li>
//               <li><Link href="/orders/track-order" className="hover:text-[#F7931E] transition-all">Tracking Your Order</Link></li>
...
//           <div className="text-center sm:text-left">
//             <h4 className={`font-black uppercase text-[var(--footer-heading-font-size)] tracking-[0.4em] mb-10 text-brand-primary`}>
//               Assistance
//             </h4>
//             <ul className="space-y-6 text-[var(--footer-body-font-size)] font-bold text-blue-100/90">
//               <li><Link href="/support" className="hover:text-[#F7931E] transition-all">Help Center</Link></li>
...
//                  <span className="text-lg md:text-2xl 2xl:text-[16px] text-neutral-white">
//                    {settings?.supportPhone ?? brandDefaults.supportPhone}
//                  </span>
//               </div>
//               <div className="flex flex-col gap-1">
//                  <span className="text-[12px] uppercase tracking-[0.3em] text-brand-primary">Email Support</span>
//                  <span className="text-lg md:text-xl 2xl:text-[16px] text-neutral-white break-words">
//                    {settings?.supportEmail ?? brandDefaults.supportEmail}
//                  </span>
//               </div>
//             </div>
