...
//   return (
//     <div className="flex items-center justify-end w-full px-6 md:px-4 py-10 md:py-2 lg:hidden">
//       {/* <HamburgerMenu> */}
//         {/* ✅ Now SearchBar is a separate component */}
//         <SearchBar />
...
//         {/* User Section */}
//         {/* ... keep your existing User, Cart, Help sections here ... */}
//       </HamburgerMenu>
//     </div>
//   );
// }
