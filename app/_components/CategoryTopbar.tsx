  ...
  return (
    <nav className="bg-accent-navy shadow-md border-t border-gray-200">
      <div className="flex items-center justify-center px-6 py-3">
        {/* Title */}
        <span className="mr-8 text-brand-primary sm:text-md md:text-[8px] lg:text[10px]  font-bold uppercase tracking-wide">
          Categories
        </span>
          ...
          {categories.map((cat) => (
            ...
            >
              ...
              <Link
                ...
                sm:text-md md:text-[7px] lg:text-[7px] xl:text-[11px]  rounded-xl 
              ...
              <AnimatePresence>
                {cat.children?.length > 0 && hovered === cat.name && (
                  <motion.div
                    ...
                    className="absolute -left-31 top-full bg-white shadow-xl text-xl rounded-md mt-3 z-50 w-[900px] px-20 pt-2"
                  >
