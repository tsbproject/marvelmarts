...
//   const { data: session } = useSession(); // Access current user session
...
//   // Updated helper to include Message Icon
...
//       case 'message': return <MessageSquare size={16} />; // New Icon
//       default: return <ShieldAlert size={16} />;
//     }
//   };

//   // Updated helper to include Message Color
...
//       case 'message': return 'bg-emerald-100 text-emerald-600'; // New Color
