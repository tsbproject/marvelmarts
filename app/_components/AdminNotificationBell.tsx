  ...
  useEffect(() => {
    ...
    orderChannel.bind(
      ...
      (data: any) => {
        ...
        notifySuccess(
          `Refund Request: Order #${data.orderId
            ?.slice(-6)
            ?.toUpperCase()}`
        );
      }
    ...
    orderChannel.bind(
      ...
      (data: any) => {
        ...
        notifyError(
          `Order Cancelled: Order #${data.orderId
            ?.slice(-6)
            ?.toUpperCase()}`
        );
      }
      ...
      (data: any) => {
        ...
        dispatch(
          addNotification({
            ...
            link:
              `/dashboard/admins/disputes/${data.id}`,
      ...
      (data: any) => {
        ...
        dispatch(
          addNotification({
            ...
            message:
              `${data.storeName} is waiting for approval`,
      ...
      (data: any) => {
        ...
        dispatch(
          addNotification({
            ...
            message:
              `${data.email} submitted a support request`,

            link:
              `/dashboard/admins/support/tickets/${data.id}`,
    ...
    >
      ...
      {isOpen && (
        ...
        >
          ...
          <div
            className="
              p-5 border-b border-neutral-50
              ...
              notifications.map((n) => (
                ...
                <Link
                  ...
                  className={`
                    ...
                    p-4 border-b border-neutral-50
                    hover:bg-neutral-50
                    transition-colors
                    ${
                      !n.isRead
