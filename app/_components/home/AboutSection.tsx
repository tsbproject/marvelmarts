...
export default function AboutPage() {
  return (
    <main className="bg-white text-gray-900">
      {/* Hero Section */}
      <section className="relative py-20 lg:py-32 bg-[#001f3f] text-white rounded-2xl                                overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
          ...
          <p className="max-w-3xl mx-auto text-xl text-gray-300 leading-relaxed font-medium">
      ...
      <section className="py-20 max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-6">
            <h2 className="text-3xl font-bold text-[#001f3f]">Why We Created MarvelMarts</h2>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12">
            <div className="bg-white p-10 rounded-3xl border border-gray-200">
              <h3 className="text-2xl font-bold mb-4 text-aceent-navy">The Merchant Experience</h3>
            ...
            <div className="bg-white p-10 rounded-3xl border border-gray-200">
              <h3 className="text-2xl font-bold mb-4 text-accent-navy">The Customer Journey</h3>
              <p className="text-gray-600 leading-relaxed italic">
      ...
      <section className="py-24 max-w-5xl mx-auto px-6 text-center">
        ...
        <div className="space-y-8 text-xl text-gray-600 leading-relaxed">
          ...
          <p>
            Today, <span className="text-gray-900 font-semibold">MarvelMarts</span> is more than just an online marketplace. We are building the foundation for a vibrant digital commerce ecosystem that supports Nigerian entrepreneurship and makes quality products accessible to millions of people across the country.
          </p>
        </div>
      </section>
