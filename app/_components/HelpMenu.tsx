...
const defaultItems = [
  ...
  { label: "Return Policy", description: "30-day money back guarantee", href: "/return-policy", icon: RefreshCcw, color: "text-red-500" },
];
    ...
    <>
      ...
      >
        <div className="relative p-2 cursor-pointer transition-transform duration-300 group-hover:scale-110">
          <HelpCircle className="w-7 h-7 xxs:w-5 xxs:h-5 md:w-8 md:h-8 2xl:w-5 2xl:5 text-brand-primary group-hover:text-blue-600 transition-colors" />
          <span className="absolute text-md 2xl:text-[13px] font-medium top-3 -right-6 text-gray-50 hidden lg:block">
            Help
          </span>
        ...
        <AnimatePresence>
          {helpOpen && (
            <motion.div
              ...
              className="absolute -right-10 md:-right-10 top-full pt-4 z-10000 w-[300px] md:w-[380px]"
            >
              <div className="bg-white rounded-3xl shadow-[0_25px_60px_rgba(0,0,0,0.2)] border border-gray-100 overflow-hidden">
                      ...
                      return (
                        <motion.div key={itemLabel || item.id} variants={itemVariants}>
                          ...
                          >
                            ...
                            <ChevronRight
                              size={14}
                              className="text-gray-300 group-hover/item:text-blue-400 group-hover/item:translate-x-1 transition-all"
                            />
                          </Link>
                        </motion.div>
                      );
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 py-4 bg-accent-navy hover:bg-blue-700 text-white transition-colors group/chat"
                >
