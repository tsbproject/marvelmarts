  ...
  return (
   <div className="
      ...
      <div className="mb-10 text-center lg:text-left">
        <h1 className="text-lg md:text-xl xl:text-2xl 2xl:text-3xl font-black text-neutral-dark tracking-tight mb-3">
          Sign In
        </h1>
        <p className="text-neutral-dark font-medium text-lg md:text-xl text-balance">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <button
            ...
            className="
              ...
              rounded-2xl
              font-black
              text-xs xl:text-sm 2xl:text-lg
              hover:bg-accent-navy
              transition-all
              active:scale-[0.97]
              disabled:opacity-70
              flex items-center justify-center gap-3
              shadow-xl shadow-[#002B5B]/20
      ...
      <div className="relative my-12">
        ...
        <div className="relative flex justify-center text-[10px] uppercase font-black text-gray-400 tracking-[0.3em]">
      ...
      <div className="grid grid-cols-2 gap-4">
        <button
          onClick={() => signIn("google", { callbackUrl: intendedPath || "/" })}
        ...
        <button
          onClick={() => signIn("facebook", { callbackUrl: intendedPath || "/" })}
