          ...
          <div className="space-y-2">
            ...
            {Number(customAmount) >
              ...
              <p className="text-[9px] font-bold text-red-500 uppercase">
                Maximum:
                ₦{MAX_FUND.toLocaleString()}
              </p>
            )}
          </div>

          <label className="flex items-start gap-3 p-4 rounded-2xl border border-brand-primary/15 bg-brand-primary/5 cursor-pointer hover:border-brand-primary transition-all">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="font-black uppercase text-[11px] text-accent-navy">
                  Save this card
                </span>
              </div>

              <p className="text-[10px] text-neutral-gray mt-1 leading-relaxed">
                Save this card securely for
                future wallet funding. Your
