...
//       {/* Header */}
//       <div
//         className="flex items-center justify-between bg-brand-primary text-white px-4 py-3 cursor-pointer rounded-t-md shadow-md "
...
export default function CategorySidebar() {
  ...
  return (
    <div className="w-full md:w-95 z-20">
      {/* Header */}
      <div
        className="flex items-center justify-between bg-brand-primary text-white px-4 py-3 cursor-pointer rounded-t-md shadow-md"
        onClick={() => setOpen(!open)}
