              ...
              <div className="p-4">
                {activeTab === "categories" ? (
                  ...
                  <ul className="space-y-3">
                    ...
                    {/* Account button (icon + label in front) */}
                    <li className="px-4 py-3 lg:hidden">
                      ...
                      {/* <button
                        ...
                        className="flex items-center gap-3 text-2xl text-gray-800 hover:text-accent-navy transition-colors"
                      >
                        <User className="w-6 h-6 text-blue-600" />
                        <span className="font-semibold lg;hidden">Account</span>
                      </button> */}
                    </li>
                  </ul>
                )}
