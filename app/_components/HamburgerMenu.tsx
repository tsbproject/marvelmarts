...
//    * - Closes drawer
//    * - Shows loader
//    * - Used everywhere (menu + categories)
//    */
...
//           <Menu className="w-10 h-10 text-brand-primary" />
//           <span className="hidden sm:block text-sm font-bold uppercase tracking-tighter text-brand-primary">
//             Menu
//           </span>
//         </div>
//       </button>
...
//                 <div>
//                   <h2 className="text-xl font-black text-accent-navy tracking-tight">
//                     MARVELMARTS
//                   </h2>
...
//                       exit={{ opacity: 0, y: -10 }}
//                     >
//                       {/*GUARANTEED CLOSE ON CATEGORY CLICK */}
//                       <CategoryMenu
...
//                             >
//                               <div className="flex items-center gap-3">
//                                 <div className="p-2 rounded-lg bg-accent-navy/5 text-accent-navy">
//                                   {item.icon}
//                                 </div>
...
//                   }}
//                   className="w-full flex items-center gap-4 p-4 rounded-2xl bg-accent-navy text-neutral-white hover:bg-neutral-dark transition-all shadow-lg"
//                 >
...
export default function HamburgerMenu({ categories }: { categories: CategoryTree[] }) {
  ...
  /**
   * CORE NAVIGATION HANDLER
   * This function ensures that clicking a final link 
   * (Category or Menu Item) shuts the drawer and triggers the transition.
   */
  const handleNavClick = () => {
    setMenuOpen(false);
    setLoading(true);
    // Mimic tactical loading feel for MarvelMarts
    setTimeout(() => setLoading(false), 800);
  };
                ...
                <AnimatePresence mode="wait">
                  {activeTab === "categories" ? (
                    <motion.div
                      ...
                      exit={{ opacity: 0, y: -10 }}
                    >
                      {/* SUCCESS: Passing handleNavClick to the onClose prop.
                        This bridges the gap so CategoryMobileMenu can close this drawer.
                      */}
                      <CategoryMenu
                        initialCategories={categories}
                        onClose={handleNavClick}
