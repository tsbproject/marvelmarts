  ...
  return (
    <>
      ...
      <button onClick={() => setOpen(true)} className="group relative p-2 transition-transform active:scale-90">
        <ShoppingCart className="w-8 h-8 text-brand-primary group-hover:text-blue-600 transition-colors" />
        <span className=" absolute text-xl font-medium top-3 -right-12 text-gray-50 hidden lg:block ">Cart</span>
