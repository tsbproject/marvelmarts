...
//               {/* TACTICAL UPDATE: Passing Product Context to the Chat Component */}
//               <ChatWithVendor 
            ...
            {product.vendorProfile && (
              <div className="flex items-center gap-4 py-5 border-y border-gray-100 mb-8 group">
                ...
                <div className="flex flex-col">
                  ...
                  >
                    <span className="font-black italic uppercase text-xl text-[#002B5B] hover:text-[#F7931E] transition-colors leading-none">
