...
export default async function ArticleDetailPage({ 
  ...
  // 1. Await the promise to get the slug
  const resolvedParams = await params;
  const slug = resolvedParams?.slug;

  // 2. CRITICAL SAFETY GUARD: 
  // This prevents the PrismaClientValidationError (slug: undefined) you saw earlier.
  if (!slug) {
    notFound();
  }
...
// 3. ADD THIS: Performance Booster
// This pre-renders all articles on Vercel so they load instantly 
// and don't trigger "deferral" interventions on mobile.
