...
import { PendingApprovalView } from "@/app/_components/PendingApprovalView"; 
import { RejectedView } from "@/app/_components/RejectedView";
import { ShieldAlert, Mail, RefreshCw, LayoutDashboard, User, Package, Wallet, Truck, MessageSquare, Settings } from "lucide-react";
...
const DASHBOARD_CONFIG = {
  ...
  VENDOR: {
    "Management": [
      { label: "Dashboard", href: "/account/vendor/dashboard", icon: <LayoutDashboard size={16} /> },
    ...
    "Finances": [
      ...
      { label: "Wallet & Payouts", href: "/account/vendor/balance", icon: <Wallet size={16} /> },
    ]
  }
};
