...
// export default function QuickFundModal({ isOpen, onClose, onSuccess }: any) {
//   const [customAmount, setCustomAmount] = useState<string>("");
//   const QUICK_AMOUNTS = [2000, 5000, 10000, 20000];
//   const MAX_FUND = 500000; // Set a 500k limit for safety
...
//     email: email,
//     amount: amountToPay * 100, // Paystack works in Kobo
...
//     onSuccess(amountToPay); // Trigger the balance sync we built earlier
//   };
...
//           <button onClick={onClose} className="absolute top-4 right-4 p-2 hover:bg-white/10 rounded-full transition-all"><X size={20} /></button>
//           <div className="flex items-center gap-3">
//             <Zap className="text-accent-navy" fill="currentColor" size={28} />
//             <h2 className="text-2xl font-black italic uppercase leading-none">Power Up</h2>
//           </div>
//         </div>
...
//             <div className="relative flex justify-center text-[9px] uppercase font-black bg-white px-3 text-neutral-gray">Enter Any Amount</div>
//           </div>

//           {/* CUSTOM LARGE AMOUNT INPUT */}
//           <div className="space-y-2">
//             <div className="relative group">
//               <span className="absolute left-5 top-1/2 -translate-y-1/2 font-black text-accent-navy text-xl">₦</span>
//               <input 
//                 type="number" 
//                 value={customAmount}
...
//               <p className="text-[9px] font-bold text-red-500 uppercase">Limit: ₦{MAX_FUND.toLocaleString()}</p>
//             )}
//           </div>

//           <button 
//             disabled={!customAmount || Number(customAmount) < 500 || Number(customAmount) > MAX_FUND}
...
//             <ShieldCheck size={12} className="text-brand-primary" /> MarvelMarts Encrypted
//           </p>
//         </div>
//       </div>
//     </div>
