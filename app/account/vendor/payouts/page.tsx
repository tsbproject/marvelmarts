...
//   vendorProfile: state.vendor?.profile, // For bank details
//   user: state.auth?.user // ADD THIS BACK for Pusher/User ID
// }), shallowEqual);
...
//     dispatch(fetchVendorPayouts()); // Load withdrawal history
//   }, [dispatch]);
...
//       } else {
//         notifyError(`PAYOUT REJECTED: ${data.remarks}`);
//       }
      
//       // Sync everything to reflect balance changes or new history status
//       dispatch(fetchVendorProfile());
...
//       amount,
//       // Updated to use vendorProfile fields
//       bankName: vendorProfile?.bankName || "Registered Bank", 
//       accountNumber: vendorProfile?.accountNumber || "0000000000",
//       accountName: vendorProfile?.accountName || "Vendor Account"
//     })).unwrap();
...
//         >
//           <RefreshCcw size={14} className={`text-brand-primary ${loading ? 'animate-spin' : 'group-hover:rotate-180 transition-transform duration-500'}`} />
//           <span className="text-[10px] font-black uppercase text-accent-navy tracking-widest">Refresh Balance</span>
//         </button>
//       </div>
...
//         {/* WALLET CARD */}
//         <div className="lg:col-span-2 bg-accent-navy rounded-[2.5rem] p-8 text-white relative overflow-hidden shadow-2xl shadow-accent-navy/20">
...
//                 <span className="text-xl font-black text-brand-primary">₦</span>
//                 <input 
//                   type="number" 
//                   placeholder="ENTER AMOUNT TO WITHDRAW"
//                   className="bg-transparent border-none outline-none w-full text-sm font-black placeholder:text-white/30 uppercase"
//                   value={payoutAmount}
...
//                 type="submit"
//                 disabled={loading}
//                 className="bg-brand-primary hover:bg-white hover:text-accent-navy text-accent-navy px-8 py-4 rounded-2xl font-black text-xs uppercase transition-all flex items-center justify-center gap-2 disabled:opacity-50"
//               >
//                 {loading ? <Loader2 className="animate-spin" /> : <><ArrowUpRight size={18} /> Request Payout</>}
//               </button>
//             </form>
//           </div>
//           <div className="absolute -bottom-24 -right-24 w-80 h-80 bg-brand-primary/10 rounded-full blur-3xl" />
//         </div>
...
//                     <span className="text-xs font-black uppercase text-accent-navy">Total Earned</span>
//                   </div>
//                   <span className="font-black text-accent-navy">{formatNaira(totalEarned)}</span>
//                 </div>
//                 <div className="flex items-center justify-between">
//                   <div className="flex items-center gap-3">
//                     <div className="p-2 bg-orange-50 text-orange-600 rounded-xl"><Clock size={20}/></div>
//                     <span className="text-xs font-black uppercase text-accent-navy">Pending Delivery</span>
//                   </div>
//                   <span className="font-black text-accent-navy">
...
//           <div className="flex items-center gap-3">
//             <div className="bg-accent-navy/5 p-2 rounded-lg text-accent-navy">
//                 <History size={18} />
//             </div>
//             <span className="text-[11px] font-black uppercase text-accent-navy tracking-widest">Withdrawal Logs</span>
//           </div>
//         </div>
...
//                     <td className="px-8 py-5 font-black text-[10px] text-accent-navy uppercase tracking-tighter">
//                       #{log.id.slice(-8)}
//                     </td>
//                     <td className="px-8 py-5 font-bold text-[10px] text-neutral-gray uppercase">
//                       {new Date(log.createdAt).toLocaleDateString()}
//                     </td>
//                     <td className="px-8 py-5 font-black text-xs text-accent-navy">
