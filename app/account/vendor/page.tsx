        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm">
                <div className="flex justify-between items-center mb-8">
                   <h3 className="text-xl font-black text-accent-navy uppercase tracking-tight italic">Top Inventory</h3>
                ...
                <div className="space-y-4">
                  {mappedProducts.length > 0 ? mappedProducts.map(product => (
                    <div key={product.id} className="flex items-center gap-4 p-5 bg-gray-50/50 rounded-3xl group border border-transparent hover:border-brand-primary/20 hover:bg-white hover:shadow-xl transition-all duration-300">
                      ...
                      <div className="text-right">
                        <p className="font-black text-accent-navy text-lg italic tracking-tighter">{formatNaira(Number(product.price))}</p>
                      </div>
                    </div>
                  )) : (
