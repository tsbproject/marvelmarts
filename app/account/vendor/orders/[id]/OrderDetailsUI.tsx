...
//   Calendar, X, Printer, Mail,
//   CreditCard, Info, ShieldCheck, ArrowLeft,
//   MessageSquare, Hash
// } from "lucide-react";
...
//   return (
//     <div className={`flex flex-col bg-[#FBFBFB] print:bg-white ${isDrawer ? 'h-full shadow-2xl' : 'min-h-screen'}`}>
      
//       {/* HEADER: Dynamic based on View Mode */}
//       <div className="p-6 border-b bg-white flex justify-between items-center print:hidden">
...
//           )}
//           <h2 className="text-xl font-black text-accent-navy uppercase tracking-tighter">
...
//             className="flex items-center gap-2 px-4 py-2 bg-gray-100 hover:bg-gray-200 text-accent-navy text-[10px] font-black uppercase rounded-xl transition-all"
//           >
...
//       <div className="p-4 md:p-8 max-w-5xl mx-auto w-full space-y-6 print:p-0">
...
//                   <h2 className="text-2xl font-black text-accent-navy uppercase flex items-center gap-2">
//                     <Hash size={20} className="text-brand-primary" /> {order.id.toUpperCase()}
//                   </h2>
//                 </div>
...
//                     <span>•</span>
//                     <span>Unit: {formatNaira(Number(dynamicOrder.items?.[0]?.unitPrice || order.total))}</span>
//                   </div>
//                 </div>
//               </div>
//             </div>
...
//                         <p className="text-[11px] font-medium text-amber-900 leading-tight italic">"{dynamicOrder.orderNotes}"</p>
//                       </div>
//                     </div>
//                   )}
//                 </div>
...
//                    <div className="w-12 h-12 rounded-xl bg-accent-navy flex items-center justify-center text-white font-black uppercase overflow-hidden border-2 border-white shadow-sm">
//                       {order.user?.image ? (
//                         <Image src={order.user.image} alt="User" width={48} height={48} className="object-cover"/>
//                       ) : (
//                         <span className="text-lg">{dynamicOrder.customerName?.charAt(0) || "U"}</span>
//                       )}
//                    </div>
//                    <div className="overflow-hidden">
//                       <p className="text-xs font-black text-accent-navy uppercase truncate leading-none mb-1">
...
//                     <div className="flex items-center gap-2 text-[10px] font-black text-neutral-gray uppercase">
//                       <Calendar size={12} className="text-brand-primary" /> Ordered On
//                     </div>
...
//                       <ShieldCheck size={12} /> Payment
//                     </div>
//                     <p className="text-[10px] font-black text-green-700">PAID {formatNaira(Number(order.total))}</p>
//                   </div>
//                 </div>
//               </div>
//             </div>
