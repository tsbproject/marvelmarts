...
//         disabled={!!loading}
//         className="flex items-center justify-center gap-2 px-6 py-3 bg-accent-navy hover:bg-green-600 text-white rounded-xl font-black text-[9px] uppercase tracking-widest transition-all disabled:opacity-50"
//       >
...
import { updateVendorStatus } from "@/store/vendorSlice"; 
