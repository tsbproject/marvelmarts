...
export default function VendorIdentityCard({
  ...
  if (!vendor) {
    return (
      <div className="w-80 bg-white rounded-[2.5rem] p-8 border border-neutral-100 shadow-sm">
        <p className="text-[10px] font-black text-[#002B5B] uppercase tracking-widest mb-2">
          Vendor Profile
        </p>
  ...
  const storefrontHref = vendor.storefrontSlug
    ? `/shop/vendor/${vendor.storefrontSlug}`
    : "#";
    ...
    <div className="w-80 flex flex-col gap-4">
      <div className="bg-[#002B5B] rounded-[2.5rem] p-6 text-white shadow-xl">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h4 className="font-black uppercase text-xs truncate w-40">
              {vendor.storeName || "Unknown Vendor"}
            </h4>
            <p className="text-[9px] text-blue-200 font-bold tracking-widest uppercase">
              Certified Vendor
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4 border-t border-white/10 pt-6">
          <div>
            <p className="text-[8px] font-black text-blue-300 uppercase mb-1">
              Trust Score
            </p>
            <div className="flex items-center gap-1 text-[#F7931E]">
              <Star size={12} fill="currentColor" />
      ...
      <div className="bg-white rounded-[2.5rem] p-6 border border-neutral-100 shadow-sm">
        <p className="text-[10px] font-black text-[#002B5B] uppercase tracking-widest mb-4">
          Security Profile
        </p>
        ...
        <a
          href={storefrontHref}
          target={storefrontHref === "#" ? undefined : "_blank"}
          rel={storefrontHref === "#" ? undefined : "noopener noreferrer"}
          className={`w-full mt-6 py-4 rounded-2xl text-[10px] font-black uppercase flex items-center justify-center gap-2 group transition-all ${
            storefrontHref === "#"
              ? "bg-neutral-100 text-neutral-400 cursor-not-allowed pointer-events-none"
              : "bg-neutral-100 hover:bg-[#002B5B] hover:text-white"
          }`}
        >
          View Storefront{" "}
          <ExternalLink
