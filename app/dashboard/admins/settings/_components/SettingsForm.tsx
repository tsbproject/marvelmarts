...
//             <p className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em]">Individual Scale Controls</p>
//           </div>
//         </header>
...
//                 <label className="text-[10px] font-black uppercase tracking-widest text-gray-400">Base Root Size (rem base)</label>
...
//             </div>
//             <input 
//                 type="range" name="headingFontSize" min="0.8" max="2.5" step="0.1"
...
//             </div>
//             <input 
//                 type="range" name="bodyFontSize" min="0.8" max="2.0" step="0.05"
...
//             </div>
//             <textarea name="footerDesc" defaultValue={settings?.footerDesc} className="w-full bg-[#F8F8F8] rounded-2xl p-6 min-h-[120px] outline-none font-medium text-lg border-2 border-transparent focus:border-[var(--brand-primary)]" />
//         </div>
//       </section>
        ...
        <section className="bg-white p-8 md:p-12 rounded-[3.5rem] shadow-xl border border-gray-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mb-12">
            ...
            <div className="space-y-6">
              ...
              <input 
                  type="range" name="baseFontSize" min="12" max="20" 
                  value={fontSize} onChange={(e) => setFontSize(parseInt(e.target.value))}
                  className="w-full h-3 bg-gray-100 rounded-xl appearance-none cursor-pointer accent-[var(--brand-primary)]" 
              />
            ...
            <div className="space-y-6">
              ...
              <input 
                  type="range" name="headingFontSize" min="0.7" max="2.0" step="0.05"
                  value={headingScale} onChange={(e) => setHeadingScale(parseFloat(e.target.value))}
                  className="w-full h-3 bg-gray-100 rounded-xl appearance-none cursor-pointer accent-orange-600" 
              />
            </div>
            ...
            <div className="space-y-6">
              ...
              <input 
                  type="range" name="bodyFontSize" min="0.8" max="1.5" step="0.02"
                  value={bodyScale} onChange={(e) => setBodyScale(parseFloat(e.target.value))}
                  className="w-full h-3 bg-gray-100 rounded-xl appearance-none cursor-pointer accent-gray-800" 
              />
            </div>
