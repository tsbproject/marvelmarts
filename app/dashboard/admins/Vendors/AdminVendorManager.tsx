...
// import { 
//   CheckCircle, Store, Mail, Loader2, Search, AlertCircle, 
...
//   };
//   store?: {
//     verificationDoc?: string; // This is where Cloudinary URL lives
//   };
// }
...
//   const { vendors, searchQuery, pagination, statusFilter } = useSelector((state: RootState) => state.vendor);
//   const [loading, setLoading] = useState(true);
//   const [actionId, setActionId] = useState<string | null>(null);
  
//   // State for the Review Sidebar
//   const [selectedVendor, setSelectedVendor] = useState<any | null>(null);

//   // 1. UPDATED FILTER LOGIC (Search + Status)
...
//       });
//       if (res.ok) {
//         dispatch(updateVendorStatusInStore({ vendorId, action }));
//         notifySuccess(`Vendor ${action.toLowerCase()} successful`);
//         if (selectedVendor?.id === vendorId) setSelectedVendor(null); // Close sidebar on success
//       } else {
...
//               <div className="mb-8">
//                 <p className="text-[10px] font-black text-gray-400 uppercase mb-4 tracking-widest">Verification Document</p>
//                 {selectedVendor.verificationImage ? (
//                   <div className="rounded-[1.5rem] overflow-hidden border-4 border-gray-50 shadow-inner bg-gray-50 group relative">
//                     <img 
//                       src={selectedVendor.verificationImage} 
//                       alt="ID Proof" 
//                       className="w-full h-auto object-contain min-h-[200px]" 
//                     />
//                     <a 
//                       href={selectedVendor.verificationImage} 
//                       target="_blank" 
...
//                   </div>
//                 ) : (
//                   <div className="h-48 rounded-[1.5rem] border-2 border-dashed border-gray-200 flex flex-col items-center justify-center text-gray-400 italic text-xs">
...
//                 <div>
//                   <p className="text-[10px] font-black text-gray-400 uppercase mb-1 tracking-widest">Store Name</p>
//                   <p className="font-black text-[#1E1E1E]">{selectedVendor.storeName}</p>
//                 </div>
//                 <div>
...
// Updated Interface to match your Prisma "store" relation
interface Vendor {
  id: string;
  storeName: string;
  status: "PENDING" | "APPROVED" | "REJECTED";
          ...
          <div className="p-6 h-full flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto pr-2 custom-scrollbar">
              <div className="mb-8">
                ...
                {/* POINTING TO vendor.store.verificationDoc */}
                {/* Corrected path: it is direct, not inside store */}
              ...
              <div className="space-y-6">
                ...
                <div>
                  <p className="text-[10px] font-black text-gray-400 uppercase mb-1 tracking-widest">Merchant Name</p>
                  <p className="font-bold text-gray-700">{selectedVendor.user?.name || "N/A"}</p>
                </div>
                <div>
                  <p className="text-[10px] font-black text-gray-400 uppercase mb-1 tracking-widest">Email Address</p>
                  <p className="font-bold text-gray-700">{selectedVendor.user?.email || "N/A"}</p>
                </div>
              </div>
            </div>
