...
// }) {
//   return (
//     <div className="w-full max-w-7xl md:max-w-screen mx-auto px-2 sm:px-4 md:px-6 lg:px-8">
//       {/* ===================== */}
//       {/* MOBILE VIEW (Cards) */}
//       {/* ===================== */}
...
//                   <p className="wrap-break-words">{enabledPermissions}</p>
//                 </div>
//               </div>
...
//         <table className="min-w-full table-fixed border-collapse border border-gray-300 text-base sm:text-lg md:text-xl">
//           <thead>
//             <tr className="bg-gray-100">
//               <th className="border px-4 py-3 text-left align-middle">Name</th>
//               <th className="border px-4 py-3 text-left align-middle">Email</th>
//               <th className="border px-4 py-3 text-left align-middle">Role</th>
//               <th className="border px-4 py-3 text-left align-middle">Created</th>
//               <th className="border px-4 py-3 text-left align-middle">Permissions</th>
//               <th className="border px-4 py-3 text-left align-middle">Actions</th>
//             </tr>
//           </thead>
...
//                   <td className="border px-4 py-3 align-middle">{admin.name || "—"}</td>
          ...
          return (
            ...
            >
              <div className="space-y-3">
                ...
                <div>
                  <p className="text-gray-500 text-sm sm:text-base">Permissions</p>
                  <p className="break-words">{enabledPermissions}</p>
                </div>
              </div>
          ...
          <table className="w-full table-fixed border-collapse border border-gray-300 text-base sm:text-lg md:text-xl">
            ...
            <tbody>
              {(admins ?? []).map((admin) => {
                ...
                return (
                  <tr key={admin.id} className="hover:bg-gray-50 transition">
                    <td className="border px-4 py-3 align-middle break-words">{admin.name || "—"}</td>
                    <td className="border px-4 py-3 align-middle break-words">{admin.email}</td>
                    <td className="border px-4 py-3 align-middle font-semibold">{admin.role}</td>
                    <td className="border px-4 py-3 align-middle">
                      {new Date(admin.createdAt).toLocaleString()}
                    </td>
                    <td className="border px-4 py-3 align-middle break-words">{enabledPermissions}</td>
                    <td className="border px-4 py-3 align-middle">
                      <div className="flex items-center flex-wrap gap-2">
                        {(canManageAdmins || isSelf) && (
                          <Link
