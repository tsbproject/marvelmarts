...
//                     {session.user.role === "SUPER_ADMIN" && (
//                       <>
//                         <Link href={`/dashboard/admins/${a.id}/edit`} className="text-sm text-blue-600 hover:underline">
//                           Edit
//                         </Link>
//                         <button
//                           onClick={async () => {
...
import { format } from "date-fns";
import DashboardSidebar from "@/app/_components/DashboardSidebar";
// import AdminActions from "./AdminActions"; // <- add this
