...
//         // Updated message to reflect the Toggle nature
//         notifySuccess(`Successfully updated group settings for ${selectedIds.size} products`);
...
//                   return (
//                     <tr key={p.id} className={`transition-colors ${selectedIds.has(p.id) ? 'bg-blue-50/30' : 'hover:bg-gray-50/50'}`}>
