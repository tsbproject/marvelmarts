...
//     email: "", verificationCode: "VERIFIED", firstName: "", lastName: "",
...
//   // --- PRE-FILL LOGIC FOR RE-APPLICATION ---
//   useEffect(() => {
//     async function fetchExistingData() {
//       try {
//         const res = await fetch("/api/vendor/profile/me"); // Endpoint to get logged-in vendor draft
//         if (res.ok) {
...
//               firstName: data.vendor.user.firstName || "",
//               lastName: data.vendor.user.lastName || "",
...
//             setStep(2); // Skip step 1 for re-applicants
//           }
//         }
//       } catch (err) {
//         console.error("No existing session found or fetch failed");
//       } finally {
...
//       } else {
//         notifyError(data.error || data.details || "Failed to send code");
//       }
//     } catch (err) {
...
//         isReapplication: isReapplying, // Flag to tell backend to update instead of create
//       };
...
//                 {isReapplying ? "Update Application" : "Merchant Onboarding"}
//               </h2>
//               <p className="text-[#FFE8CC] font-bold text-sm mt-1 uppercase tracking-tighter">
//                 {isReapplying ? "Fix your details and scale with Marvelmarts" : "Scale your business with Marvelmarts"}
//               </p>
//             </div>
//             <div className="w-10" /> 
//           </div>
...
//                   <RefreshCcw className="text-blue-600 animate-spin-slow" size={18} />
//                   <p className="text-[10px] font-black text-blue-700 uppercase italic">Re-application Mode: Your existing data has been loaded.</p>
//                 </div>
//               )}
...
//               <div className="space-y-3">
//                 <label className="text-xs font-black uppercase tracking-widest text-[#4B4B4B] ml-1 flex items-center gap-2">
//                   <Lock size={16} className="text-[#F7931E]" /> {isReapplying ? "Confirm Password" : "Create Secure Password"}
//                 </label>
...
//                 >
//                   {loading.submit ? "RESUBMITTING..." : isReapplying ? "RESUBMIT APPLICATION" : "OPEN MY STORE"}
//                 </button>
//               </div>
//             </div>
//           )}
