...
// import bcrypt from "bcryptjs"; // bcryptjs is safe for serverless environments
...
// // POST: create admin (server) — requires an authenticated admin
...
//     // only admins or super admins can create admin
//     if (!(currentUser.role === "SUPER_ADMIN" || currentUser.role === "ADMIN" && currentUser.permissions?.manageAdmins)) {
...
//     const safePermissions: PermissionsShape = { ...DEFAULT_PERMISSIONS, ...(permissions ?? {}) };
...
//         passwordHash,
//         role,
//         // careful with exact case in schema (IsVerified vs isVerified). Use your schema field.
//         IsVerified: false,
//         adminProfile: {
//           create: {
