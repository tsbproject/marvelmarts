        ...
        data: [
            {
                ...
                price: new client_1.Prisma.Decimal(139.99),
                status: client_1.ProductStatus.ACTIVE, //enum reference
                stock: 60,
            ...
            },
            {
                ...
                price: new client_1.Prisma.Decimal(999.99),
            ...
            },
            {
                ...
                price: new client_1.Prisma.Decimal(599.99),
                status: client_1.ProductStatus.ACTIVE,
                stock: 20,
            ...
            },
            {
                ...
                price: new client_1.Prisma.Decimal(89.99),
                status: client_1.ProductStatus.ACTIVE,
                stock: 80,
        ...
        if (product.categoryId === shoesCategory.id) {
            ...
            await prisma.variant.createMany({
                data: [
                    ...
                    { productId: product.id, name: "256GB", sku: `${product.slug}-256gb`, price: (product.price.add(new client_1.Prisma.Decimal(100))).toString(), stock: 8 },
                ],
            });
        }
...
async function seedReviews() {
    ...
    const sampleUsers = await prisma.user.findMany({
        where: { role: client_1.UserRole.CUSTOMER }, //enum reference
        take: 5,
    });
