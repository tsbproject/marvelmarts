...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var email, password, hashedPassword, existingAdmin, newAdmin;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log("🚀 Creating Super Admin...");
                    email = "superadmin@marvelmarts.com";
                    password = "SuperAdmin123!";
                    return [4 /*yield*/, bcrypt_1.default.hash(password, 10)];
                case 1:
                    hashedPassword = _a.sent();
                    return [4 /*yield*/, prisma_1.prisma.admin.findUnique({ where: { email: email } })];
                case 2:
                    ...
                    return [4 /*yield*/, prisma_1.prisma.admin.create({
                            data: {
                                name: "Super Admin",
                                email: email,
...
main()
    .catch(function (err) { return console.error("❌ Error creating Super Admin:", err); })
